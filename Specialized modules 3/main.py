...
"""
Module: main.py
Ties together the simulation, optimization, visualization, and analysis modules.
Usage:
...
def main():
    ...
    if args.convergence:
        ...
        analysis_results = run_systematic_error_analysis(base_params, resolutions, time_steps, ensemble_runs=3)

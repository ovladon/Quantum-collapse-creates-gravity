...
from simulation import run_field_simulation_3D_base as run_field_simulation_3D, parameter_sensitivity_analysis, convergence_test
...
if __name__ == "__main__":
    gen_results = genetic_algorithm_optimization(generations=3, population_size=5)

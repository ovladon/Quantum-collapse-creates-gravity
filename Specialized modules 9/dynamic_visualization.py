...
def animate_test_particles(folder, interp_factor=10, dt_effect=0.1, num_particles=10, use_numba=True):
    ...
    def update(frame_index):
        ...
        if use_numba:
            positions, velocities = update_particles_numba(positions, velocities, grad_x, grad_y, sim_params["L"], N, dt_effect)
        else:
...
if __name__ == "__main__":
    ...
    animate_test_particles(args.folder, interp_factor=args.interp_factor, dt_effect=args.dt_effect, num_particles=args.num_particles, use_numba=args.use_numba)

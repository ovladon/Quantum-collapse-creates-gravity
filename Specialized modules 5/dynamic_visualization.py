...
def animate_test_particles(folder, interp_factor=10, dt_effect=0.1, num_particles=10):
    """
    ...
    def update(frame_index):
        ...
        # Compute gradients (returns [grad_y, grad_x])
...
# Alias for backward compatibility with gui_app.py

...
class App(tk.Tk):
    ...
    def create_vis_tab(self):
        ...
        explanation = (
            ...
            "------------------------\n"
            "This section produces PNG charts from simulation snapshots and provides a dynamic interactive animation.\n"
            "The interactive animation uses the saved simulation archive to interpolate additional frames and simulates\n"
            "matter point movement under the influence of the field's gradient. Use the slider in the animation window\n"
            "to navigate through the simulation evolution.\n"
    ...
    def launch_interactive_animation(self):
        ...
        try:
            launch_interactive_visualization(folder, interp_factor=10, dt_effect=0.1, num_points=50)
        except Exception as e:
